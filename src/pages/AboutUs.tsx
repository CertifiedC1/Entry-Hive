    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="container mx-auto relative z-10">
          <h1 className="text-5xl font-bold text-white mb-4 text-center">Create A Lifestyle & Build Brand Legacies</h1>
      ...
      <section className="py-16 px-4 bg-muted/20">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">2025 at a Glance</h2>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">About Our Success</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-lg bg-card border">
              <p className="text-5xl font-bold text-primary mb-2">120+</p>
              <p className="text-muted-foreground">Successful Events</p>
            </div>
            <div className="text-center p-6 rounded-lg bg-card border">
            ...
            <div className="text-center p-6 rounded-lg bg-card border">
              <p className="text-5xl font-bold text-primary mb-2">20K+</p>
